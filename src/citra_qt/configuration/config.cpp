...
void Config::ReadValues() {
    ...
    Settings::values.web_services_url =
        ReadSetting("web_services_url", "https://api.citra-emu.org").toString().toStdString();
...
void Config::SaveValues() {
    ...
    WriteSetting("web_services_url", QString::fromStdString(Settings::values.web_services_url),
