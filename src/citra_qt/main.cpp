...
void GMainWindow::InitializeHotkeys() {
    ...
    hotkey_registry.RegisterHotkey("Main Window", "Toggle Frame Limit", QKeySequence("CTRL+B"));
    ...
    hotkey_registry.RegisterHotkey("Main Window", "Remove Amiibo", QKeySequence(Qt::Key_F3),
                                   Qt::ApplicationShortcut);
    hotkey_registry.RegisterHotkey("Main Window", "Capture Screenshot", QKeySequence(tr("CTRL+S")));
    ...
    connect(hotkey_registry.GetHotkey("Main Window", "Show Toolbar", render_window),
            &QShortcut::activated, ui.action_Show_Toolbar, &QAction::trigger);
    ...
    connect(hotkey_registry.GetHotkey("Main Window", "Toggle Frame Limit", render_window),
                        &QShortcut::activated, this, &GMainWindow::ToggleFramelimit);
