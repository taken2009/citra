...
QtKeyboardDialog::QtKeyboardDialog(QWidget* parent, QtKeyboard* keyboard_) : keyboard(keyboard_) {
...
void QtKeyboard::OpenInputDialog() {
    ...
    dialog.exec();
    NGLOG_INFO(Frontend, "SWKBD input dialog finished, text={}, button={}",
               dialog.text.toStdString(), dialog.button);
