...
static void PrintHelp(const char* argv0) {
    std::cout << "Usage: " << argv0
              << " [options] <filename>\n"
                 ...
                 "--web-services-url  The web service url to the announce server\n"
...
int main(int argc, char** argv) {
    ...
    static struct option long_options[] = {
        ...
        {"web-services-url", required_argument, 0, 'a'},
    ...
    while (optind < argc) {
        ...
        if (arg != -1) {
            ...
            case 't':
                ...
                break;
            case 'a':
                web_services_url.assign(optarg);
                break;
            case 'h':
                PrintHelp(argv[0]);
                return 0;
    ...
    if (web_services_url.empty() && announce) {
        announce = false;
        std::cout << "endpoint url is empty: Hosting a private room\n\n";
    }
    if (announce) {
        std::cout << "Hosting a public room\n\n";
        Settings::values.web_services_url = web_services_url;
